    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 sm:px-0">
      <div className="max-w-md w-full space-y-6 sm:space-y-8 p-6 sm:p-8 bg-white rounded-xl shadow-lg">
        <div className="text-center">
          <Image src="/logo.png" alt="Logo" width={64} height={64} className="h-12 sm:h-16 w-auto mx-auto mb-3 sm:mb-4" />
          ...
          <div>
            {session ? (
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-sm sm:text-base"
              >
