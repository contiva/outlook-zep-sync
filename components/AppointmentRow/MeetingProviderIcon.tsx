...
function TeamsSvg({ gradientId, className }: { gradientId: string; className?: string }) {
  return (
    ...
    >
      ...
      <linearGradient id={gradientId} gradientUnits="userSpaceOnUse" x1="198.099" y1="1683.0726" x2="942.2344" y2="394.2607" gradientTransform="matrix(1 0 0 -1 0 2075.3333)">
        <stop offset="0" stopColor="#5a62c3"/><stop offset=".5" stopColor="#4d55bd"/><stop offset="1" stopColor="#3940ab"/>
      </linearGradient>
      <path fill={`url(#${gradientId})`} d="M95.01 466.5h950.312c52.473 0 95.01 42.538 95.01 95.01v950.312c0 52.473-42.538 95.01-95.01 95.01H95.01c-52.473 0-95.01-42.538-95.01-95.01V561.51c0-52.472 42.538-95.01 95.01-95.01z"/>
...
function ZoomSvg({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" aria-label="Zoom Meeting">
...
function CalendlySvg({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" aria-label="Calendly">
...
function GoogleMeetSvg({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 87.5 72" xmlns="http://www.w3.org/2000/svg" aria-label="Google Meet" preserveAspectRatio="xMidYMid meet">
...
const svgComponents: Record<MeetingProvider, React.FC<{ className?: string; gradientId?: string }>> = {
