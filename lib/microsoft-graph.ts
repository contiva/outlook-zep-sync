...
export async function getCalendarEvents(
  ...
  let url: string | null = (() => {
    ...
    u.searchParams.set(
      '$select',
      'id,subject,start,end,bodyPreview,body,attendees,organizer,isOrganizer,type,seriesMasterId,isOnlineMeeting,onlineMeetingProvider,onlineMeeting,isCancelled,lastModifiedDateTime,location',
    );
    return u.toString();
  })();
